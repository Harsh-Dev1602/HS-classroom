                ...
                <h2 className="Text_Color font-bold mb-4">Create Course</h2>
                 <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col">
                        <div className="mb-4 flex flex-col">
                            <input  {...register("title", { required: true })} placeholder="Title" className="bg-white Box_Shedow outline-none rounded-md p-2 " type="text" />
                            {errors.title && <span className='mt-1 text-red-600 font-semibold'>This field is required</span>}
                        </div>
                        <div className="mb-4 flex flex-col">
                            <input  {...register("description", { required: true })} placeholder="Description" className="bg-white Box_Shedow rounded-md p-2 outline-none" type="text" />
                            {errors.description && <span className='mt-1 text-red-600 font-semibold'>This field is required</span>}
                        </div>
                        <div className="mb-4 flex flex-col">
                            <input  {...register("thumbnail", { required: true })} placeholder="Thumbnail" className="bg-white Box_Shedow rounded-md p-2 outline-none" type="text" />
