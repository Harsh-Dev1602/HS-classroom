        ...
        {courses.map(r => (
          <div key={r._id} className=" w-full h-auto rounded-2xl p-4 Box_Shedow gap-3 ">
                ...
                <div className="flex justify-between items-center mt-4">
                  <button onClick={() => navigate(`/student/lecture/${r._id}`)} className="text-[#145da0] border-2 border-[#145da0]  font-bold py-1 px-3 cursor-pointer rounded-2xl ">Continue</button>
